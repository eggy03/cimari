...
class Win32SoundDeviceServiceTest {
    ...
    private final Win32SoundDevice expectedDevice1 = new Win32SoundDevice.Builder()
            .deviceId("AUDIO\\0001")
            ...
            .statusInfo(3)
            .build();
    private final Win32SoundDevice expectedDevice2 = new Win32SoundDevice.Builder()
            .deviceId("AUDIO\\0002")
