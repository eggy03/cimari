...
class Win32NetworkAdapterToConfigurationServiceTest {
    ...
    private static Win32NetworkAdapterToConfiguration expectedObject;
    ...
    static void setJson() {
        ...
        object.addProperty("DeviceID", "123456");
        object.add("Adapter", null);
        object.add("Configurations", null);

        array.add(object);

        json = new GsonBuilder().serializeNulls().create().toJson(array);

        expectedObject = Win32NetworkAdapterToConfiguration.builder()
                .deviceId("123456")
                .build();
    }
    ...
    @BeforeEach
    void setService() {
        service = new Win32NetworkAdapterToConfigurationService();
    }
    ...
    void test_get_success() {
        ...
        try (MockedStatic<PowerShell> mockPS = mockStatic(PowerShell.class);
            ...
            List<Win32NetworkAdapterToConfiguration> objectList = service.get();
    ...
    void test_getWithSession_success() {
        ...
        try (PowerShell mockSession = mock(PowerShell.class)) {
            ...
            List<Win32NetworkAdapterToConfiguration> objectList = service.get(mockSession);
            assertThat(objectList).hasSize(1);
            assertThat(objectList.get(0)).usingRecursiveComparison().isEqualTo(expectedObject);
        }
    }
    ...
    void test_getWithTimeout_success() {
        ...
        try (MockedStatic<TerminalUtility> mockedTerminal = mockStatic(TerminalUtility.class)) {
            ...
            List<Win32NetworkAdapterToConfiguration> objectList = service.get(5L);
            assertThat(objectList).hasSize(1);
            assertThat(objectList.get(0)).usingRecursiveComparison().isEqualTo(expectedObject);
        }
    }
    ...
    void test_entityFieldParity_withTestJson() {
        ...
        Field[] declaredClassFields = Win32NetworkAdapterToConfiguration.class.getDeclaredFields();
