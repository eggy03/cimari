...
class Win32ProcessorToCacheMemoryServiceTest {
    ...
    private static Win32ProcessorToCacheMemory expectedObject;
    ...
    static void setJson() {
        ...
        object.add("Processor", null);
        object.add("CacheMemory", null);

        array.add(object);

        json = new GsonBuilder().serializeNulls().create().toJson(array);

        expectedObject = Win32ProcessorToCacheMemory.builder()
                .deviceId("123456")
                .build();
    }
    ...
    @BeforeEach
    void setService() {
        service = new Win32ProcessorToCacheMemoryService();
    }
    ...
    void test_get_success() {
        ...
        try (MockedStatic<PowerShell> mockPS = mockStatic(PowerShell.class);
            ...
            List<Win32ProcessorToCacheMemory> objectList = service.get();
    ...
    void test_getWithSession_success() {
        ...
        try (PowerShell mockSession = mock(PowerShell.class)) {
            ...
            List<Win32ProcessorToCacheMemory> objectList = service.get(mockSession);
            assertThat(objectList).hasSize(1);
            assertThat(objectList.get(0)).usingRecursiveComparison().isEqualTo(expectedObject);
        }
    }
    ...
    void test_getWithTimeout_success() {
        ...
        try (MockedStatic<TerminalUtility> mockedTerminal = mockStatic(TerminalUtility.class)) {
            ...
            List<Win32ProcessorToCacheMemory> objectList = service.get(5L);
            assertThat(objectList).hasSize(1);
            assertThat(objectList.get(0)).usingRecursiveComparison().isEqualTo(expectedObject);
        }
    }
    ...
    void test_entityFieldParity_withTestJson() {
        ...
        Field[] declaredClassFields = Win32ProcessorToCacheMemory.class.getDeclaredFields();
