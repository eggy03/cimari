...
class Win32DiskPartitionToLogicalDiskServiceTest {
    ...
    private static Win32DiskPartitionToLogicalDisk expectedObject;
    ...
    static void setJson() {
        ...
        object.addProperty("PartitionID", "Disk 0 Partition 1");
        object.add("Partition", null);
        ...
        expectedObject = Win32DiskPartitionToLogicalDisk.builder()
    ...
    @BeforeEach
    void setService() {
        service = new Win32DiskPartitionToLogicalDiskService();
    }
    ...
    void test_getWithTimeout_success() {
        ...
        try (MockedStatic<TerminalUtility> mockedTerminal = mockStatic(TerminalUtility.class)) {
            ...
            List<Win32DiskPartitionToLogicalDisk> objectList = service.get(5L);
            assertThat(objectList).hasSize(1);
            assertThat(objectList.get(0)).usingRecursiveComparison().isEqualTo(expectedObject);
        }
    }
    ...
    void test_entityFieldParity_withTestJson() {
        ...
        Field[] declaredClassFields = Win32DiskPartitionToLogicalDisk.class.getDeclaredFields();
