...
@JsonSerialize(as = Win32DiskDriveToDiskPartition.class)
@JsonDeserialize(as = Win32DiskDriveToDiskPartition.class)
public abstract class AbstractWin32DiskDriveToDiskPartition {
