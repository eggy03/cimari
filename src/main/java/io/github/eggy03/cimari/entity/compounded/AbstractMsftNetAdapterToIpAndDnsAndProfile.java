...
@JsonSerialize(as = MsftNetAdapterToIpAndDnsAndProfile.class)
@JsonDeserialize(as = MsftNetAdapterToIpAndDnsAndProfile.class)
public abstract class AbstractMsftNetAdapterToIpAndDnsAndProfile {
    ...
    @Nullable
    public abstract AbstractMsftNetAdapter adapter();
    ...
    @Nullable
    public abstract List<@Nullable AbstractMsftNetIpAddress> ipAddressList();
    ...
    @Nullable
    public abstract List<@Nullable AbstractMsftDnsClientServerAddress> dnsClientServerAddressList();
    ...
    @Nullable
    public abstract List<@Nullable AbstractMsftNetConnectionProfile> netConnectionProfileList();
