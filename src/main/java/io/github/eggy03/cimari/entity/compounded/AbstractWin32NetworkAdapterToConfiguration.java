...
@JsonSerialize(as = Win32NetworkAdapterToConfiguration.class)
@JsonDeserialize(as = Win32NetworkAdapterToConfiguration.class)
public abstract class AbstractWin32NetworkAdapterToConfiguration {
    ...
    @Nullable
    public abstract AbstractWin32NetworkAdapter adapter();
    ...
    @Nullable
    public abstract List<@Nullable AbstractWin32NetworkAdapterConfiguration> configurationList();
