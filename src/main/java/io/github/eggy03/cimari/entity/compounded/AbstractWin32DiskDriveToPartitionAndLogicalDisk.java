...
@JsonSerialize(as = Win32DiskDriveToPartitionAndLogicalDisk.class)
@JsonDeserialize(as = Win32DiskDriveToPartitionAndLogicalDisk.class)
public abstract class AbstractWin32DiskDriveToPartitionAndLogicalDisk {
    ...
    @Nullable
    public abstract AbstractWin32DiskDrive diskDrive();
    ...
    @Nullable
    public abstract List<@Nullable AbstractWin32DiskPartition> diskPartitionList();
    ...
    @Nullable
    public abstract List<@Nullable AbstractWin32LogicalDisk> logicalDiskList();
