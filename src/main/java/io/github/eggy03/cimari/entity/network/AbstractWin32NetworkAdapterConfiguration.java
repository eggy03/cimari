...
@JsonSerialize(as = Win32NetworkAdapterConfiguration.class)
@JsonDeserialize(as = Win32NetworkAdapterConfiguration.class)
public abstract class AbstractWin32NetworkAdapterConfiguration {
